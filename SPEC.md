...
## Repo / deploy
Git remote (SSH): `https://github.com/AZagatti/pokedex-off-r1.git` (already created, empty). `git init`, set remote `origin`, commit
in logical chunks, push to `main`. `paths.base` must be `/pokedex-off-r1`. The live URL will be
